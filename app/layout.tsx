...
export const metadata: Metadata = {
  title: {
    default: 'MedTech Review — Independent Medical Technology Reviews',
    template: '%s | MedTech Review',
  },
  description:
  ...
  metadataBase: new URL('https://medtechreview.com'),
  openGraph: {
    type: 'website',
    locale: 'en_US',
    siteName: 'MedTech Review',
  },
  twitter: {
  ...
  verification: {
    google: 'P7mqzXD7V8dM4s0EXyDCf2qDLlaSJv2xTyfgBYNU0vM',
  },
}
  ...
  return (
    <html lang="en" className={`${inter.variable} ${merriweather.variable}`}>
      <head>
        ...
        <meta name="impact-site-verification" value="683b1aff-e461-4e2a-bec0-84c3ba5937ab" />
      </head>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        <a href="/" className="flex items-center gap-2.5">
          <span className="text-white font-serif text-xl font-bold tracking-tight">
            MedTech<span className="text-blue-400">Review</span>
          </span>
          <span className="hidden sm:inline text-xs text-blue-300 border border-blue-700 px-2 py-0.5 rounded">
            Independent
          </span>
        </a>
    ...
    <footer className="bg-blue-950 text-blue-300 mt-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <p className="font-serif text-white font-bold text-lg mb-2">MedTech Review</p>
            <p className="text-sm text-blue-400 leading-relaxed">
              Independent, evidence-based reviews of medical technology and health products.
            </p>
          </div>
          <div>
            <p className="text-white text-sm font-semibold mb-3">Disclosure</p>
            <p className="text-xs text-blue-400 leading-relaxed">
              This site contains affiliate links. We only recommend products we have independently
              evaluated. Content is for informational purposes only and does not constitute medical
              advice.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-1.5 text-xs text-blue-400">
              ...
              <li>
                <a href="/affiliate-disclosure" className="hover:text-blue-200 transition-colors">
        ...
        <div className="border-t border-blue-900 pt-6 text-xs text-blue-600 text-center">
          © {new Date().getFullYear()} MedTech Review. All rights reserved.
        </div>
      </div>
    </footer>
  )
